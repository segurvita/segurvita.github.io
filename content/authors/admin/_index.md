...
STYLYで『STYLY Studio』開発チームのリードエンジニアを務め、現在はコンテンツ制作部のチーフエンジニアを担当しています。上級VR技術者（VR学会認定）。Unity認定プログラマー。XRMV制作者。個人活動として、魚介類のモデル制作・販売、Vketへの出展など、精力的に取り組んでいます。なお、「Segur」はフランス語読みで「せぎゅ」と読みます。
